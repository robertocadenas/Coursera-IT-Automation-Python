...
print("-------------------------------")
print("**format()** method: The format() method is used to format strings. It replaces the curly braces with matching values, indexed values, or named values.")
print("{:.2f}")
print("**len(string)** function: The len() function returns the length of a string.")
print("**string[x]** indexing: Indexing is used to access individual characters in a string. The index starts at 0.")
print("**string[x:y]** slicing: Slicing is used to extract a substring from a string. The substring includes characters from index x to y-1.")
print("**string.replace(old, new)** method: The replace() method replaces all occurrences of the old substring with the new substring in a string.")
print("**string.lower()** method: The lower() method converts all characters in a string to lowercase.")
print("**string.upper()** method: The upper() method converts all characters in a string to uppercase.")
print("**string.strip()** method: The strip() method removes leading and trailing whitespace characters from a string.")
print("**string.split(separator)** method: The split() method splits a string into a list of substrings using the specified separator.")
print("**string.join(iterable)** method: The join() method concatenates the elements of an iterable using the string as a separator.")
print("")

# Coding Skills
print("\nCoding Skills")
print("-------------")
# Skill group 1: For loo and upper examples
print("Skill group 1: For loop and upper() method")
...
# Skill group 2: Using the format() method
print("\nSkill group 2: Using the format() method")
...
# Skill group 3: Using format() method and indexing
print("\nSkill group 3: Using format() method and indexing")
...
# Skill group 4: Using replace() method and len() function
print("\nSkill group 4: Using replace() method and len() function")
